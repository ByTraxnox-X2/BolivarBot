...
const msg = {
    ...
    mods: '*\Este comando solo puede ser usado por el propietario del bot.\*',
    premium: '*\Este comando solo puede ser usado por usuaris premium, y para mí creador.\*',
    group: '*\Este comando solo puede ser usado en grupos.\`*',
    private: '*\Este comando solo puede ser usado en chat privado del bot.\*',
    ...
    unreg: '*\Necesitas estar registrado(a) para usar este comando, escriba #rᥱg para registrarte.\*',
    restrict: '*\Comando restringido por la decisión del propietario del bot.\*'
  }[type];
